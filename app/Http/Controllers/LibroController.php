...
class LibroController extends Controller
{
    ...
    {
        //
        $this->validate($request,['nombre'=>'required','resumen'=>'required', 'npagina'=>'required', 'edicion'=>'required', 'autor'=>'required', 'precio'=>'required', 'precio'=>'required']);
    ...
    public function update(Request $request, $id)
    {
        ...
        $libro=Libro::Find($id)->update($request->all());
